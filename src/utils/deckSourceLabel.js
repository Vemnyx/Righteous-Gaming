/**
 * Display label for a deck's source. Member decks show the owner's Discord name (or email).
 *
...
export function deckSourceLabel(deck) {
  ...
  if (src.toLowerCase() === "member") {
    const discordName = deck.owner_username != null ? String(deck.owner_username).trim() : "";
