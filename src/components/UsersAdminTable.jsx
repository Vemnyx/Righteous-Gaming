 ...
 */
export function UsersAdminTable({ isLight, active }) {
  const { user } = useAuth();
  ...
  return (
    <div className="flex w-full flex-1 flex-col gap-4 px-1 py-2 sm:px-2">
      <div className="text-left">
        <h2 className="text-lg font-semibold tracking-tight text-[#f4f0fa]">Users</h2>
        <p className="mt-1 text-[0.8125rem] text-[#f4f0fa]/60">
          All registered accounts (admin only). Data loads when this tab is open.
        </p>
      </div>
