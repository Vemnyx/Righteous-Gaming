...
CREATE INDEX user_card_rankings_set_id_idx ON user_card_rankings (set_id);
...
CREATE INDEX user_card_rankings_user_set_format_idx ON user_card_rankings (user_id, set_id, format);
